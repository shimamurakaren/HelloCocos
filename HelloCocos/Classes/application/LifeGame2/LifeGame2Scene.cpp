...
const Color3B LifeGame2Scene::SELL_COLOR[STATUS_MAX] = {
	{ 0, 0, 0 },
	{ 0, 255, 0 }
};

const float LifeGame2Scene::SELL_UPDATE_TIME = 0.08f;
...
void LifeGame2Scene::updateSell()
{
	// 計算
	for (int y = 0; y < SELL_ROW; y++)
	{
...
int LifeGame2Scene::calculateAliveCount(int x, int y)
{
	Sell &sell = m_sell[y][x];
	int alive = 0;
...
bool LifeGame2Scene::isSellContain(int x, int y)
{
